...
function afdEndpointsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdEndpoints.beginDeleteAndWait(resourceGroupName, profileName, endpointName);
        console.log(result);
    });
}
afdEndpointsDelete().catch(console.error);
//# sourceMappingURL=afdEndpointsDeleteSample.js.map