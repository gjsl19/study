...
function originGroupsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.originGroups.beginDeleteAndWait(resourceGroupName, profileName, endpointName, originGroupName);
        console.log(result);
    });
}
originGroupsDelete().catch(console.error);
//# sourceMappingURL=originGroupsDeleteSample.js.map