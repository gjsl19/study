...
function routesCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.routes.beginCreateAndWait(resourceGroupName, profileName, endpointName, routeName, route);
        console.log(result);
    });
}
routesCreate().catch(console.error);
//# sourceMappingURL=routesCreateSample.js.map