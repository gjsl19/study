...
export class RulesImpl {
    ...
    listByRuleSetPagingPage(resourceGroupName, profileName, ruleSetName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByRuleSetPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByRuleSet(resourceGroupName, profileName, ruleSetName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByRuleSetNext(resourceGroupName, profileName, ruleSetName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByRuleSetPagingAll(resourceGroupName, profileName, ruleSetName, options) {
        return __asyncGenerator(this, arguments, function* listByRuleSetPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByRuleSetPagingPage(resourceGroupName, profileName, ruleSetName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(resourceGroupName, profileName, ruleSetName, ruleName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, ruleSetName, ruleName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreate(resourceGroupName, profileName, ruleSetName, ruleName, rule, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, ruleSetName, ruleName, rule, options }, createOperationSpec);
    ...
    beginDelete(resourceGroupName, profileName, ruleSetName, ruleName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, ruleSetName, ruleName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "azure-async-operation"
