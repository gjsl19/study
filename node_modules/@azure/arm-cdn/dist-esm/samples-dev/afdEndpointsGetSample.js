...
function afdEndpointsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdEndpoints.get(resourceGroupName, profileName, endpointName);
        console.log(result);
    });
}
afdEndpointsGet().catch(console.error);
//# sourceMappingURL=afdEndpointsGetSample.js.map