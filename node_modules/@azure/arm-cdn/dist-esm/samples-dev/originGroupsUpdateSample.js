...
function originGroupsUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.originGroups.beginUpdateAndWait(resourceGroupName, profileName, endpointName, originGroupName, originGroupUpdateProperties);
        console.log(result);
    });
}
originGroupsUpdate().catch(console.error);
//# sourceMappingURL=originGroupsUpdateSample.js.map