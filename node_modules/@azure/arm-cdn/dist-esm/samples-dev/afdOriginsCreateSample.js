...
function afdOriginsCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdOrigins.beginCreateAndWait(resourceGroupName, profileName, originGroupName, originName, origin);
        console.log(result);
    });
}
afdOriginsCreate().catch(console.error);
//# sourceMappingURL=afdOriginsCreateSample.js.map