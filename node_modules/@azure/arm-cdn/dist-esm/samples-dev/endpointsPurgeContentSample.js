 ...
 */
function endpointsPurgeContent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.endpoints.beginPurgeContentAndWait(resourceGroupName, profileName, endpointName, contentFilePaths);
        console.log(result);
    });
}
endpointsPurgeContent().catch(console.error);
//# sourceMappingURL=endpointsPurgeContentSample.js.map