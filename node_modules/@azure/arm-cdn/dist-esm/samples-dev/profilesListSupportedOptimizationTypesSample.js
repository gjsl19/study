 ...
 */
function profilesListSupportedOptimizationTypes() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.profiles.listSupportedOptimizationTypes(resourceGroupName, profileName);
        console.log(result);
    });
}
profilesListSupportedOptimizationTypes().catch(console.error);
//# sourceMappingURL=profilesListSupportedOptimizationTypesSample.js.map