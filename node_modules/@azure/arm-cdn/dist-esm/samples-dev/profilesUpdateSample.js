...
function profilesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.profiles.beginUpdateAndWait(resourceGroupName, profileName, profileUpdateParameters);
        console.log(result);
    });
}
profilesUpdate().catch(console.error);
//# sourceMappingURL=profilesUpdateSample.js.map