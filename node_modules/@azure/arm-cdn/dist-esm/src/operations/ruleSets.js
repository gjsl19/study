...
export class RuleSetsImpl {
    ...
    listResourceUsagePagingPage(resourceGroupName, profileName, ruleSetName, options, settings) {
        return __asyncGenerator(this, arguments, function* listResourceUsagePagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listResourceUsage(resourceGroupName, profileName, ruleSetName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listResourceUsageNext(resourceGroupName, profileName, ruleSetName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listResourceUsagePagingAll(resourceGroupName, profileName, ruleSetName, options) {
        return __asyncGenerator(this, arguments, function* listResourceUsagePagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listResourceUsagePagingPage(resourceGroupName, profileName, ruleSetName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    get(resourceGroupName, profileName, ruleSetName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, ruleSetName, options }, getOperationSpec);
    }
    /**
    ...
    create(resourceGroupName, profileName, ruleSetName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, ruleSetName, options }, createOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, profileName, ruleSetName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, ruleSetName, options }, deleteOperationSpec);
    ...
    _listResourceUsage(resourceGroupName, profileName, ruleSetName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, ruleSetName, options }, listResourceUsageOperationSpec);
    }
    /**
     * ListByProfileNext
     * @param resourceGroupName Name of the Resource group within the Azure subscription.
    ...
    _listResourceUsageNext(resourceGroupName, profileName, ruleSetName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, ruleSetName, nextLink, options }, listResourceUsageNextOperationSpec);
    }
}
