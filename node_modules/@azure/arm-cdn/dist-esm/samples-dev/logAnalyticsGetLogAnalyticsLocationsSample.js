 ...
 */
function logAnalyticsGetLogAnalyticsLocations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.logAnalytics.getLogAnalyticsLocations(resourceGroupName, profileName);
        console.log(result);
    });
}
logAnalyticsGetLogAnalyticsLocations().catch(console.error);
//# sourceMappingURL=logAnalyticsGetLogAnalyticsLocationsSample.js.map