...
export class SecretsImpl {
    ...
    get(resourceGroupName, profileName, secretName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, secretName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreate(resourceGroupName, profileName, secretName, secret, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, secretName, secret, options }, createOperationSpec);
    ...
    beginDelete(resourceGroupName, profileName, secretName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, secretName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "azure-async-operation"
