...
function originsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.origins.beginDeleteAndWait(resourceGroupName, profileName, endpointName, originName);
        console.log(result);
    });
}
originsDelete().catch(console.error);
//# sourceMappingURL=originsDeleteSample.js.map