...
function routesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.routes.beginUpdateAndWait(resourceGroupName, profileName, endpointName, routeName, routeUpdateProperties);
        console.log(result);
    });
}
routesUpdate().catch(console.error);
//# sourceMappingURL=routesUpdateSample.js.map