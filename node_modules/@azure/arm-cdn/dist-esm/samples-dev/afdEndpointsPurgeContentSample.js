 ...
 */
function afdEndpointsPurgeContent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdEndpoints.beginPurgeContentAndWait(resourceGroupName, profileName, endpointName, contents);
        console.log(result);
    });
}
afdEndpointsPurgeContent().catch(console.error);
//# sourceMappingURL=afdEndpointsPurgeContentSample.js.map