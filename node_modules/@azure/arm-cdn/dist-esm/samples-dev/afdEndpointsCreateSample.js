...
function afdEndpointsCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdEndpoints.beginCreateAndWait(resourceGroupName, profileName, endpointName, endpoint);
        console.log(result);
    });
}
afdEndpointsCreate().catch(console.error);
//# sourceMappingURL=afdEndpointsCreateSample.js.map