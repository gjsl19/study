...
function endpointsStop() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.endpoints.beginStopAndWait(resourceGroupName, profileName, endpointName);
        console.log(result);
    });
}
endpointsStop().catch(console.error);
//# sourceMappingURL=endpointsStopSample.js.map