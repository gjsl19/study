 ...
 */
function customDomainsEnableCustomHttpsUsingCdnManagedCertificate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.customDomains.beginEnableCustomHttpsAndWait(resourceGroupName, profileName, endpointName, customDomainName);
        console.log(result);
    });
}
 ...
 */
function customDomainsEnableCustomHttpsUsingYourOwnCertificate() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "subid";
        const resourceGroupName = "RG";
        const profileName = "profile1";
...
//# sourceMappingURL=customDomainsEnableCustomHttpsSample.js.map