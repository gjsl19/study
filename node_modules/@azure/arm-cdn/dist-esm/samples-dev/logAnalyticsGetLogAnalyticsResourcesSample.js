 ...
 */
function logAnalyticsGetLogAnalyticsResources() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.logAnalytics.getLogAnalyticsResources(resourceGroupName, profileName);
        console.log(result);
    });
}
logAnalyticsGetLogAnalyticsResources().catch(console.error);
//# sourceMappingURL=logAnalyticsGetLogAnalyticsResourcesSample.js.map