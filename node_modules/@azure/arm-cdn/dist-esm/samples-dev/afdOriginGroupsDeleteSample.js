 ...
 */
function afdOriginGroupsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdOriginGroups.beginDeleteAndWait(resourceGroupName, profileName, originGroupName);
        console.log(result);
    });
}
afdOriginGroupsDelete().catch(console.error);
//# sourceMappingURL=afdOriginGroupsDeleteSample.js.map