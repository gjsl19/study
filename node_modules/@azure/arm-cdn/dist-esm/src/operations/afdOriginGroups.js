...
export class AfdOriginGroupsImpl {
    ...
    listResourceUsagePagingAll(resourceGroupName, profileName, originGroupName, options) {
        return __asyncGenerator(this, arguments, function* listResourceUsagePagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listResourceUsagePagingPage(resourceGroupName, profileName, originGroupName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    get(resourceGroupName, profileName, originGroupName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, originGroupName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreate(resourceGroupName, profileName, originGroupName, originGroup, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, originGroupName, originGroup, options }, createOperationSpec);
    ...
    beginDelete(resourceGroupName, profileName, originGroupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, originGroupName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "azure-async-operation"
    ...
    _listResourceUsage(resourceGroupName, profileName, originGroupName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, originGroupName, options }, listResourceUsageOperationSpec);
    }
    /**
     * ListByProfileNext
     * @param resourceGroupName Name of the Resource group within the Azure subscription.
    ...
    _listResourceUsageNext(resourceGroupName, profileName, originGroupName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, originGroupName, nextLink, options }, listResourceUsageNextOperationSpec);
    }
}
...
//# sourceMappingURL=afdOriginGroups.js.map