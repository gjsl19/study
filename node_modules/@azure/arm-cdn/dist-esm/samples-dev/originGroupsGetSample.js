...
function originGroupsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.originGroups.get(resourceGroupName, profileName, endpointName, originGroupName);
        console.log(result);
    });
}
originGroupsGet().catch(console.error);
//# sourceMappingURL=originGroupsGetSample.js.map