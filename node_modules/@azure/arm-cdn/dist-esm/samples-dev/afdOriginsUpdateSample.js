...
function afdOriginsUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdOrigins.beginUpdateAndWait(resourceGroupName, profileName, originGroupName, originName, originUpdateProperties);
        console.log(result);
    });
}
afdOriginsUpdate().catch(console.error);
//# sourceMappingURL=afdOriginsUpdateSample.js.map