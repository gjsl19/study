...
function customDomainsCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.customDomains.beginCreateAndWait(resourceGroupName, profileName, endpointName, customDomainName, customDomainProperties);
        console.log(result);
    });
}
customDomainsCreate().catch(console.error);
//# sourceMappingURL=customDomainsCreateSample.js.map