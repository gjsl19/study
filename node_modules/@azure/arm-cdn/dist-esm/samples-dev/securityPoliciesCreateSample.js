 ...
 */
function securityPoliciesCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.securityPolicies.beginCreateAndWait(resourceGroupName, profileName, securityPolicyName, securityPolicy);
        console.log(result);
    });
}
securityPoliciesCreate().catch(console.error);
//# sourceMappingURL=securityPoliciesCreateSample.js.map