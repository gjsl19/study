...
function originGroupsCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.originGroups.beginCreateAndWait(resourceGroupName, profileName, endpointName, originGroupName, originGroup);
        console.log(result);
    });
}
originGroupsCreate().catch(console.error);
//# sourceMappingURL=originGroupsCreateSample.js.map