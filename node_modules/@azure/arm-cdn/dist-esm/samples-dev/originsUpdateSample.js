...
function originsUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.origins.beginUpdateAndWait(resourceGroupName, profileName, endpointName, originName, originUpdateProperties);
        console.log(result);
    });
}
originsUpdate().catch(console.error);
//# sourceMappingURL=originsUpdateSample.js.map