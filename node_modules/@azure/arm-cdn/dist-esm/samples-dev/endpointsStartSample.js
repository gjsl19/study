...
function endpointsStart() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.endpoints.beginStartAndWait(resourceGroupName, profileName, endpointName);
        console.log(result);
    });
}
endpointsStart().catch(console.error);
//# sourceMappingURL=endpointsStartSample.js.map