...
function createsSpecificPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.policies.beginCreateOrUpdateAndWait(resourceGroupName, policyName, cdnWebApplicationFirewallPolicy);
        console.log(result);
    });
}
createsSpecificPolicy().catch(console.error);
//# sourceMappingURL=policiesCreateOrUpdateSample.js.map