...
function afdOriginsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdOrigins.beginDeleteAndWait(resourceGroupName, profileName, originGroupName, originName);
        console.log(result);
    });
}
afdOriginsDelete().catch(console.error);
//# sourceMappingURL=afdOriginsDeleteSample.js.map