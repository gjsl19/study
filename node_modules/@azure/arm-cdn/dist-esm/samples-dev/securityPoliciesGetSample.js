...
function securityPoliciesGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.securityPolicies.get(resourceGroupName, profileName, securityPolicyName);
        console.log(result);
    });
}
securityPoliciesGet().catch(console.error);
//# sourceMappingURL=securityPoliciesGetSample.js.map