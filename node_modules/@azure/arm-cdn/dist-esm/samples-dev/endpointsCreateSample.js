...
function endpointsCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.endpoints.beginCreateAndWait(resourceGroupName, profileName, endpointName, endpoint);
        console.log(result);
    });
}
endpointsCreate().catch(console.error);
//# sourceMappingURL=endpointsCreateSample.js.map