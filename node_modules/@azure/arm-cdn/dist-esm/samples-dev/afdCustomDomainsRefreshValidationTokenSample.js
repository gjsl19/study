 ...
 */
function afdCustomDomainsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdCustomDomains.beginRefreshValidationTokenAndWait(resourceGroupName, profileName, customDomainName);
        console.log(result);
    });
}
afdCustomDomainsDelete().catch(console.error);
//# sourceMappingURL=afdCustomDomainsRefreshValidationTokenSample.js.map