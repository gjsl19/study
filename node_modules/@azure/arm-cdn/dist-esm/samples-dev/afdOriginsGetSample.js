...
function afdOriginsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdOrigins.get(resourceGroupName, profileName, originGroupName, originName);
        console.log(result);
    });
}
afdOriginsGet().catch(console.error);
//# sourceMappingURL=afdOriginsGetSample.js.map