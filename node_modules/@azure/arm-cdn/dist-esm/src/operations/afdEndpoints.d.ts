...
import { AFDEndpoint, AfdEndpointsListByProfileOptionalParams, Usage, AfdEndpointsListResourceUsageOptionalParams, AfdEndpointsGetOptionalParams, AfdEndpointsGetResponse, AfdEndpointsCreateOptionalParams, AfdEndpointsCreateResponse, AFDEndpointUpdateParameters, AfdEndpointsUpdateOptionalParams, AfdEndpointsUpdateResponse, AfdEndpointsDeleteOptionalParams, AfdPurgeParameters, AfdEndpointsPurgeContentOptionalParams, ValidateCustomDomainInput, AfdEndpointsValidateCustomDomainOptionalParams, AfdEndpointsValidateCustomDomainResponse } from "../models";
/** Class containing AfdEndpoints operations. */
export declare class AfdEndpointsImpl implements AfdEndpoints {
...
//# sourceMappingURL=afdEndpoints.d.ts.map