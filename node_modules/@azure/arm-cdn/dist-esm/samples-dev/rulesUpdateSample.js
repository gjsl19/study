...
function rulesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.rules.beginUpdateAndWait(resourceGroupName, profileName, ruleSetName, ruleName, ruleUpdateProperties);
        console.log(result);
    });
}
rulesUpdate().catch(console.error);
//# sourceMappingURL=rulesUpdateSample.js.map