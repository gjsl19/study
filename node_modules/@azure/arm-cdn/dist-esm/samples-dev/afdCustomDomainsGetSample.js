...
function afdCustomDomainsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.afdCustomDomains.get(resourceGroupName, profileName, customDomainName);
        console.log(result);
    });
}
afdCustomDomainsGet().catch(console.error);
//# sourceMappingURL=afdCustomDomainsGetSample.js.map