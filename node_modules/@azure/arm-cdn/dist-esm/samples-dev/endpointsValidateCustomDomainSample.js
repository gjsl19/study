 ...
 */
function endpointsValidateCustomDomain() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.endpoints.validateCustomDomain(resourceGroupName, profileName, endpointName, customDomainProperties);
        console.log(result);
    });
}
endpointsValidateCustomDomain().catch(console.error);
//# sourceMappingURL=endpointsValidateCustomDomainSample.js.map