...
export class AfdOriginsImpl {
    ...
    listByOriginGroupPagingPage(resourceGroupName, profileName, originGroupName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByOriginGroupPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByOriginGroup(resourceGroupName, profileName, originGroupName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByOriginGroupNext(resourceGroupName, profileName, originGroupName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByOriginGroupPagingAll(resourceGroupName, profileName, originGroupName, options) {
        return __asyncGenerator(this, arguments, function* listByOriginGroupPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByOriginGroupPagingPage(resourceGroupName, profileName, originGroupName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(resourceGroupName, profileName, originGroupName, originName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, originGroupName, originName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, profileName, originGroupName, originName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, originGroupName, originName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "azure-async-operation"
...
//# sourceMappingURL=afdOrigins.js.map