...
export class SecurityPoliciesImpl {
    /**
    ...
    get(resourceGroupName, profileName, securityPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, securityPolicyName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, profileName, securityPolicyName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, securityPolicyName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "azure-async-operation"
...
//# sourceMappingURL=securityPolicies.js.map