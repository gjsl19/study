...
export class RoutesImpl {
    ...
    get(resourceGroupName, profileName, endpointName, routeName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, endpointName, routeName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, profileName, endpointName, routeName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, endpointName, routeName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "azure-async-operation"
