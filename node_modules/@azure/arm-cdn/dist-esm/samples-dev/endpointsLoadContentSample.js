...
function endpointsLoadContent() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.endpoints.beginLoadContentAndWait(resourceGroupName, profileName, endpointName, contentFilePaths);
        console.log(result);
    });
}
endpointsLoadContent().catch(console.error);
//# sourceMappingURL=endpointsLoadContentSample.js.map