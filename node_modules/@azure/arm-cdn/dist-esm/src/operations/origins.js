...
export class OriginsImpl {
    ...
    listByEndpointPagingAll(resourceGroupName, profileName, endpointName, options) {
        return __asyncGenerator(this, arguments, function* listByEndpointPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByEndpointPagingPage(resourceGroupName, profileName, endpointName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(resourceGroupName, profileName, endpointName, originName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, profileName, endpointName, originName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, profileName, endpointName, originName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, profileName, endpointName, originName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
