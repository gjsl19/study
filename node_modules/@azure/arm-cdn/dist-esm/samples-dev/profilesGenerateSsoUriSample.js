 ...
 */
function profilesGenerateSsoUri() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.profiles.generateSsoUri(resourceGroupName, profileName);
        console.log(result);
    });
}
profilesGenerateSsoUri().catch(console.error);
//# sourceMappingURL=profilesGenerateSsoUriSample.js.map